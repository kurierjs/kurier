...
- **Transport layer integrations:** The framework supports JSONAPI operations via WebSockets, and it includes middlewares for [Koa](https://koajs.com), [Express](http://expressjs.com/), [Vercel](https://vercel.com) and [Next.js](https://nextjs.org) to automatically add HTTP endpoints for each declared resource and processor.
